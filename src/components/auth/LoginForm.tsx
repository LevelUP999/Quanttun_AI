  ...
  return (
    <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-lg">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-900">{translations.welcomeBack}</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-sm text-quanttun-purple hover:text-quanttun-darkPurple">
      ...
      <div className="text-center mt-6">
        <p className="text-sm text-gray-600">
          ...
          <Link to="/register" className="text-quanttun-purple hover:text-quanttun-darkPurple font-medium">
            {translations.signUp}
          </Link>
        </p>
      </div>
